---
title: "CLI reference"
description: "Every `warren` subcommand at v0.18.0, extracted from the command definitions in src/cli/main.ts."
editUrl: "https://github.com/jayminwest/warren/blob/v0.18.0/src/cli/main.ts"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.18.0 (src/cli/main.ts). DO NOT EDIT — change it upstream and re-sync. -->

Control plane and UI for cloud-based custom agents

Every command below is extracted from [`src/cli/main.ts`](https://github.com/jayminwest/warren/blob/v0.18.0/src/cli/main.ts) at the
