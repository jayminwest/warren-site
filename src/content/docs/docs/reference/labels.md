...
editUrl: "https://github.com/jayminwest/warren/blob/v0.16.0/docs/labels.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.16.0 (docs/labels.md). DO NOT EDIT — change it upstream and re-sync. -->

The canonical label set for warren lives in
[`.github/labels.yml`](https://github.com/jayminwest/warren/blob/v0.16.0/.github/labels.yml) and is mirrored to the
GitHub repository by
[`.github/workflows/sync-labels.yml`](https://github.com/jayminwest/warren/blob/v0.16.0/.github/workflows/sync-labels.yml).
...
1. Edit [`.github/labels.yml`](https://github.com/jayminwest/warren/blob/v0.16.0/.github/labels.yml).
