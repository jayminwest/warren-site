...
editUrl: "https://github.com/jayminwest/warren/blob/v0.11.0/docs/design/runtime-provider-contract.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.11.0 (docs/design/runtime-provider-contract.md). DO NOT EDIT — change it upstream and re-sync. -->

**Status:** Design — the seam that unblocks the migration branch
**Date:** 2026-07-09
**Feeds:** [`k8s-migration-plan.md`](https://github.com/jayminwest/warren/blob/v0.11.0/docs/design/k8s-migration-plan.md) §5.B (`runtime-contract`)
