...
editUrl: "https://github.com/jayminwest/warren/blob/v0.18.0/docs/design/runtime-provider-contract.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.18.0 (docs/design/runtime-provider-contract.md). DO NOT EDIT — change it upstream and re-sync. -->

> **HISTORICAL — shipped in v0.10.0.** This document is a design record, not a plan in flight. The contract below now lives in `src/runtime/contract.ts`, and both backends implement it — see [`docs/RUNBOOK-K8S.md`](/docs/self-host/kubernetes/) §0 for the operator view. Read the code when the two disagree.

**Status:** Design — the seam that unblocked the migration branch
**Date:** 2026-07-09
**Companion:** [`k8s-migration.md`](https://github.com/jayminwest/warren/blob/v0.18.0/docs/design/k8s-migration.md) — the architecture record this seam serves
