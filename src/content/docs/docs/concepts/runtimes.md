...
editUrl: "https://github.com/jayminwest/warren/blob/v0.14.0/docs/design/runtime-provider-contract.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.14.0 (docs/design/runtime-provider-contract.md). DO NOT EDIT — change it upstream and re-sync. -->
...
**Date:** 2026-07-09
**Companion:** [`k8s-migration.md`](https://github.com/jayminwest/warren/blob/v0.14.0/docs/design/k8s-migration.md) — the architecture record this seam serves
