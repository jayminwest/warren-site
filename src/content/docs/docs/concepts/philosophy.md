---
title: "Philosophy"
editUrl: "https://github.com/jayminwest/warren/blob/v0.16.0/docs/PHILOSOPHY.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.16.0 (docs/PHILOSOPHY.md). DO NOT EDIT — change it upstream and re-sync. -->
...
[ROADMAP.md](https://github.com/jayminwest/warren/blob/v0.16.0/ROADMAP.md). For the work queue, run `sd ready`. If a
...
[ROADMAP.md](https://github.com/jayminwest/warren/blob/v0.16.0/ROADMAP.md) owns the list of seams, their status, and
...
| What is the direction and the order of work? | [ROADMAP.md](https://github.com/jayminwest/warren/blob/v0.16.0/ROADMAP.md) |
