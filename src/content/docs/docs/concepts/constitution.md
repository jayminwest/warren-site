...
editUrl: "https://github.com/jayminwest/warren/blob/v0.14.1/docs/CONSTITUTION.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.14.1 (docs/CONSTITUTION.md). DO NOT EDIT — change it upstream and re-sync. -->
