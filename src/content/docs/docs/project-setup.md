...
editUrl: "https://github.com/jayminwest/warren/blob/v0.13.2/docs/project-setup.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.13.2 (docs/project-setup.md). DO NOT EDIT — change it upstream and re-sync. -->
