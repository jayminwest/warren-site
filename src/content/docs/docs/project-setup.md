---
title: "Project setup"
description: "Checklist for configuring a GitHub repository so warren can open PRs that auto-merge once CI passes, with branches cleaned up automatically."
editUrl: "https://github.com/jayminwest/warren/blob/v0.17.0/docs/project-setup.md"
---

<!-- GENERATED by `bun run sync:upstream` from jayminwest/warren@v0.17.0 (docs/project-setup.md). DO NOT EDIT — change it upstream and re-sync. -->
